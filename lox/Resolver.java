...
public class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
  ...
  // this is only in here so that we can populate the `locals` map in `Interpreter`... we could just as well make this whole thing simply return the `locals` map as a result
